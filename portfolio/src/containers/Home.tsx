    ...
    return (
        <Container disableGutters maxWidth="md">
            <Box pb={2}>
                ...
                <Typography variant="body1">I am a creative design graduate with a passion for story driven content, possessing considerable experience with all aspects of a media project`s lifecycle, both in front and behind the camera.</Typography>
                <br />
